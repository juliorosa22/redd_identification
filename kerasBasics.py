...
from tensorflow.keras.layers import Conv1D, Reshape,Dense, LSTM,GlobalMaxPooling1D,MaxPooling1D,GlobalAveragePooling1D, Flatten, Input,Dropout,BatchNormalization,Embedding
from tensorflow.keras.callbacks import EarlyStopping,ModelCheckpoint,CSVLogger
import tensorflow.keras.optimizers as optimizers
from tensorflow.keras.utils import to_categorical,Sequence

model_dir = curr_work_dir+'/Models/'
...
def saveHistLog(file_path,lmetrics):
    ...
    val_loss = lmetrics[3]
    f = h5py.File(model_dir+'log_'+file_path,'w')
