...
## funcao que detecta os timestamps no qual um determinado aparelho esta ligado, usando seu sinal de potencia, salvando em um arquivo , para posterior utilizacao na rotulacao do sinal main no este aparelho se encontra
# utilizar individualmente para cada aparelho, apesar de ser possivel usar para mais de um , a deteccao dos niveis diminui
...
### ___ Funcoes que processam os dados ajustados dos aparelhos juntamento com os dados de seu respectivo main

#funcao responsavel por detectar quais aparelhos estao conectados em um respectivo main, testa todas as combinaçoes
# dos sinais de aparelhos separados e compara com a leitura de potencia da main, escolhe a combinaçao de aparelhos
...
def identifyMainDevices(dir_path,devs_index,main_number):
    ...
    for i in range(7,n_devs+1):#i representa o numero de dispositivos na mistura, com no minimo 7 aparelhos conectados
...
def occurrenceDevInlabel(n_devs,mask_dev,y_pred,y_labels):
    ...
    ypred_coded=np.argmax(y_pred,1)
    print(y_coded.shape)
...
##servem p identificar q aparelhos estao conectados em determinado main por meio da combinacao dos sinais de potencias individuais q mais se aproximam com o sinal de potencia do respectivo main a ser usado
...
Estatisticas main1:
                ...
                outlets_unknown_2    electronics_1    disposal_1    furance_1   outlets_unknown_3   washer_dryer_2  lighting_3  microwave_1 smoke_alarms_1  bathroom_gfi_1  kitchen_outlets_1 kitchen_outlets_2
# in data         [8079               502448            3144            25505        159043               76198         112       11759        121174           19914           217115             59950]
# detected        [5372               492125            2646            25083        156038               76040          27        11473        110365          19618           216782             58945]
...
test       85304
                ...
                outlets_unknown_1    lighting_1    refrigerator_1    dishwasher_1   lighting_2   washer_dryer_1  lighting_4 lighting_5
# in data       [ 32049                 1292            555577          17690           289527       30065          402246      92801]
# detected       [ 29990                1272            554219          17543           288524        28980         401842      91867]
